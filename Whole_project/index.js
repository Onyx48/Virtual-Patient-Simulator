...
import connectDB from "./backend/db.js"; // Adjusted path
import "dotenv/config"; // Ensures .env variables are loaded

// --- FIX: IMPORT ALL ROUTES ---
import authRoutes from "./backend/routes/authRoutes.js";
import userRoutes from "./backend/routes/users.js"; // <--- ADDED
import studentRoutes from "./backend/routes/studentRoutes.js"; // <--- ADDED
import schoolRoutes from "./backend/routes/schoolRoutes.js"; // <--- ADDED
import scenarioRoutes from "./backend/routes/scenarioRoutes.js"; // <--- ADDED
import dashboardRoutes from "./backend/routes/dashboardRoutes.js"; // <--- ADDED
